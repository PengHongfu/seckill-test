...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active" href="<%=basePath%>Admin/toaddCategory">编辑分类</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="<%=basePath%>Admin/editCategory" method="post" >
                        <input type="hidden" value="${editCategory.cid}" name="cid">
                        <div class="form-group">
                            <label for="cname">商品分类名称</label>
                            <input class="form-control" id="cname" value="${editCategory.cname}" name="cname">
                        </div>
                        <div class="form-group">
                            <label for="cdesc">商品分类描述</label>
                            <input class="form-control" id="cdesc" value="${editCategory.cdesc}" name="cdesc" >
                        </div>
                        <button type="submit" class="btn btn-default">${empty editCategory ? '添加':'修改'}</button>
