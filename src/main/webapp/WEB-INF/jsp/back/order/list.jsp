            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active" href="<%=basePath%>Admin/orderAlllist">订单列表</a>
                            </li>
                            <li>
                    ...
                    <table class="table  table-hover">
                        ...
                        <c:forEach var="order" items="${orderAllList}" varStatus="sort">
                            <tr>
                                ...
                                <td>${order.seckillId.seckillId}/
                                    <c:if test="${fn:length(order.userId.uid)>20}">
                                        ${ fn:substring( order.userId.uid ,0,20)}...
                                    </c:if>
                                    <c:if test="${fn:length(order.userId.uid)<=20}">
                                        ${order.userId.uid}
                                    </c:if>
        ...
        var options = {
            ...
            pageUrl: function (type, page, current) {
                ...
                if (page == current) {
                    ...
                    return "<%=basePath%>Admin/orderAlllist?currentPage=" + page;
                }
