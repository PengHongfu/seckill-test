...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active" href="<%=basePath%>Admin/toseckillSearch">商品查询</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form class="form-inline" action="<%=basePath%>Admin/seckillSearch#position" method="post" >
                                        ...
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>商品描述</label>
                                            <input class="form-control" value="${seckillDesc}" name="seckillDesc" />
                                        </div>
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>上架时间</label>
                                        ...
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>秒杀开启时间</label>
                                            <input class="form-control" value="${startTime}" name="startTime" />
                                        </div>
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>秒杀结束时间</label>
                                            <input class="form-control" value="${endTime}" name="endTime"  />
                                        </div>
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>价格(以下)</label>
                                        ...
                                        <div class="form-group col-sm-6  col-lg-6">
                                            <label>商品分类</label>
                                            <input class="form-control" value="${cname}" name="cname" />
                                        </div>
            ...
            <hr>
           <c:choose>
               <c:when test="${empty seckillAllList}">
                           ...
                           <table class="table  table-hover">
                               ...
                               <c:forEach var="seckill" items="${seckillAllList}" varStatus="sort">
                                   <tr>
                                       ...
                                       <td>
                                           <a href="<%=basePath%>Admin/toAddSeckill?seckillId=${seckill.cid}" role="button" class="btn btn-primary btn-sm"><span
                                           ...
                                           <a id="<%=basePath%>Admin/deleteSeckill/${seckill.cid}" role="button" onclick="deleteBtn(this)"
        ...
        var options = {
            ...
            pageUrl: function (type, page, current) {
                ...
                if (page == current) {
                    ...
                    return "<%=basePath%>Admin/seckillSearch?currentPage=" + page+"#position";
                }
