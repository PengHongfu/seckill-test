                        ...
                        loginname: {
                            ...
                            validators: {
                                ...
                                remote: {//ajax验证。server result:{"valid",true or false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid",true}
                                    url: 'User/checkNameExistsMethod2',//验证地址
                                    message: '该用户不存在',//提示消息
...
<body>
<div class="container">
    <form id="myform" class="form-signin" action="User/login" method="post">
        <h2 class="title">你好，请登录！</h2>
        <input type="hidden" name="backseckillId" value="${backseckillId}">
        <div class="form-group has-feedback">
            <div class="input-group">
                 <span class="input-group-addon"><span class="glyphicon glyphicon-user "
                                                       aria-hidden="true"></span></span>

                <input type="text" value="${form.loginname}" class="form-control input-lg" id="loginname" name="loginname" placeholder="用户名">
            </div>
        </div>
        <div class="form-group has-feedback">
            ...
            <p class="text-warning small">${loginmsg}</p>
        </div>
        <button  type="submit" class="btn btn-primary btn-block  btn-lg">登录</button>

        <a id="registbtn" class="btn btn-primary btn-block  btn-lg" href="User/toregist" role="button">还没注册</a>
